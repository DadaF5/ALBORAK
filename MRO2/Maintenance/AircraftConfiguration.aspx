<%@ Page Language="VB" AutoEventWireup="false"
    ...
    CodeFile="AircraftConfiguration.aspx.vb"
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <button type="button" class="btn btn-sm btn-outline-secondary mr-1"
                                        onclick="document.querySelectorAll('.zone-collapse').forEach(function(el){el.style.display='';var h=el.previousSibling;while(h&&h.nodeType!==1){h=h.previousSibling;}if(h){var ic=h.querySelector('.fa-chevron-down');if(ic)ic.style.transform='';}});try{sessionStorage.removeItem('acTreeState');}catch(e){}return false;">
                                    <i class="fas fa-expand-alt"></i>
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-secondary"
                                        onclick="document.querySelectorAll('.zone-collapse').forEach(function(el){el.style.display='none';var h=el.previousSibling;while(h&&h.nodeType!==1){h=h.previousSibling;}if(h){var ic=h.querySelector('.fa-chevron-down');if(ic)ic.style.transform='rotate(-90deg)';}});return false;">
...
<script type="text/javascript">
    ...
    // NOTE: ASP.NET 3.5 HtmlGenericControl drops data-* attributes.
    // All toggle logic is fully inlined in the onclick attr in VB.
    // The expand-all / collapse-all buttons below use class selector.
