<%@ Page Language="VB" AutoEventWireup="false"
    ...
    CodeFile="AircraftConfiguration_1.aspx.vb"
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <button type="button" class="btn btn-sm btn-outline-secondary mr-1"
                                        onclick="if(window.$)$('.zone-collapse').collapse('show');return false;">
                                    <i class="fas fa-expand-alt"></i>
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-secondary"
                                        onclick="if(window.$)$('.zone-collapse').collapse('hide');return false;">
