...
Partial Class MRO2_Maintenance_AircraftConfiguration
    ...
    Private Sub BuildTree()
        ...
        For Each slotRow As DataRow In dt.Rows
            ...
            ' Zone header (clickable collapse toggle)
            ...
            zoneHeader.Attributes("data-toggle")  = "collapse"
            zoneHeader.Attributes("data-target")  = "#zone" & zoneIndex
            zoneHeader.Attributes("aria-expanded") = "true"
            ...
            zoneCollapse.ID = "zone" & zoneIndex
            zoneCollapse.Attributes("class") = "collapse show zone-collapse"
    ...
    Private Function BuildSlotRow(ByVal slot As DataRow) As Control
        ...
        Else
            ...
            sb.Append("<span class='text-dark'>" &
                      Server.HtmlEncode(slot("SerialNumber").ToString()) & "</span>")
            sb.Append("</span>")
    ...
    Private Function ZoneWorstHealth(ByVal rows As DataRow()) As String
        Dim worst As Integer = 0
        For Each r As DataRow In rows
            Dim rank As Integer = 0
            Select Case r("SlotHealth").ToString()
                Case "EXPIRED" : rank = 4
                Case "DUE"     : rank = 3
                Case "ALERT"   : rank = 2
                Case "EMPTY"   : rank = 1
