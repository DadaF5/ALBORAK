...
Partial Class MRO2_Maintenance_AircraftConfiguration
    ...
    Private Sub BuildTree()
        ...
        For Each slotRow As DataRow In dt.Rows
            ...
            ' Zone header — pure JS toggle (no Bootstrap dependency)
            ...
            ' No Bootstrap collapse class — visibility toggled by pure JS onclick above
