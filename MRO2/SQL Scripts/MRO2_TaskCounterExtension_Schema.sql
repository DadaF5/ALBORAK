...
BEGIN
    ...
    BEGIN
        RAISERROR(
            'An active extension already exists for this SN/counter. '
            & 'Revoke it before granting a new one.',
            16, 1);
        RETURN;
    END
    ...
    BEGIN
        RAISERROR(
            'Extension of %d units exceeds the pre-approved maximum '
            & 'of %d units for this task counter.',
