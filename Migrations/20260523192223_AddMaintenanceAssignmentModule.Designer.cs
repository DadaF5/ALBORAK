...
namespace FRAProject.Migrations
{
    ...
    [Migration("20260523192223_AddMaintenanceAssignmentModule")]
    partial class AddMaintenanceAssignmentModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FRAProject.Areas.AircraftMaintenance.Models.InspectionType", b =>
                {
                    ...
                    b.ToTable("InspectionTypes", "dbo");
                });

            modelBuilder.Entity("FRAProject.Areas.AircraftMaintenance.Models.MaintenanceRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MaintenanceRoles", "dbo");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "TECH",
                            Description = "Maintenance technician. Signs off own task cards.",
                            IsActive = true,
                            Name = "Technician",
                            SortOrder = (byte)1
                        },
                        new
                        {
                            Id = 2,
                            Code = "BASE_SUP",
                            Description = "Supervises maintenance within one base and aircraft group scope.",
                            IsActive = true,
                        ...
                        new
                        {
                            Id = 3,
                            Code = "MASTER_SUP",
                            Description = "Full read/write access across all bases and groups.",
                            IsActive = true,
            ...
            modelBuilder.Entity("FRAProject.Areas.AircraftMaintenance.Models.UserMaintenanceAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MaintenanceRoleId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MaintenanceRoleId");

                    b.HasIndex("UserId", "IsActive")
                        .HasDatabaseName("IX_UserMaintenanceAssignment_UserId_IsActive");

                    b.ToTable("UserMaintenanceAssignments", "dbo");
                });

            modelBuilder.Entity("FRAProject.Areas.AircraftMaintenance.Models.UserMaintenanceAssignmentGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AssignmentId", "AcMainGroupId")
                        .HasDatabaseName("IX_UserMaintenanceAssignmentGroup_Assignment_Group");

                    b.ToTable("UserMaintenanceAssignmentGroups", "dbo");
                });
            ...
            modelBuilder.Entity("FRAProject.Areas.AircraftMaintenance.Models.InspectionType", b =>
                {
                    ...
                    b.HasOne("FRAProject.Areas.AircraftMaintenance.Models.InspectionType", "NextInspectionType")
                        .WithMany("PrecedingInspectionTypes")
            ...
            modelBuilder.Entity("FRAProject.Areas.AircraftMaintenance.Models.UserMaintenanceAssignment", b =>
                {
                    ...
                    b.HasOne("FRAProject.Areas.AircraftMaintenance.Models.MaintenanceRole", "MaintenanceRole")
                        .WithMany("UserAssignments")
                        .HasForeignKey("MaintenanceRoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("FRAProject.Areas.AircraftMaintenance.Models.UserMaintenanceAssignmentGroup", b =>
                {
                    ...
                    b.HasOne("FRAProject.Areas.AircraftMaintenance.Models.UserMaintenanceAssignment", "Assignment")
            ...
            modelBuilder.Entity("FRAProject.Areas.AircraftMaintenance.Models.InspectionType", b =>
                {
                    b.Navigation("PrecedingInspectionTypes");
                });
