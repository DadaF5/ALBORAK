...
namespace FRAProject.Migrations
{
    ...
    [Migration("20260830103735_AddSquadronOpsWorkflowFields")]
    partial class AddSquadronOpsWorkflowFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FRAProject.Areas.AircraftMaintenance.Models.ComponentLifeLimitStageDimension", b =>
                {
                    ...
                    b.Property<int?>("ReferenceBasisId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FRAProject.Areas.AircraftMaintenance.Models.ComponentReferenceBasis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ComponentReferenceBases", "dbo");
                });
            ...
            modelBuilder.Entity("FRAProject.Areas.SquadronOps.Models.Odv", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FRAProject.Areas.SquadronOps.Models.Wing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FRAProject.Areas.AircraftMaintenance.Models.ComponentLifeLimitStageDimension", b =>
                {
                    ...
                    b.HasOne("FRAProject.Areas.AircraftMaintenance.Models.ComponentReferenceBasis", "ReferenceBasis")
                        .WithMany()
                        .HasForeignKey("ReferenceBasisId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("FRAProject.Areas.SquadronOps.Models.Sortie", b =>
                {
                    ...
                    b.HasOne("FRAProject.Areas.SquadronOps.Models.Odv", "Odv")
                        .WithMany("Sorties")
                        .HasForeignKey("OdvId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FRAProject.Areas.SquadronOps.Models.Squadron", b =>
                {
                    b.HasOne("FRAProject.Areas.Settings.Models.Base", "CurrentBase")
                        .WithMany()
                        .HasForeignKey("CurrentBaseId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FRAProject.Areas.SquadronOps.Models.Wing", "Wing")
                        .WithMany("Squadrons")
                        .HasForeignKey("WingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("CurrentBase");
